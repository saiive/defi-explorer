...
COPY ./packages/bitcore-lib-dfc/package.json ./packages/bitcore-lib-dfc/package.json
...
COPY ./packages/bitcore-p2p-dfc/package.json ./packages/bitcore-p2p-dfc/package.json
