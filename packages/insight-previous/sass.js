...
module.exports = {
  ...
  excludeFiles: [
    /\.(wp|ios).(scss)$/i,
    /(action-sheet|alert|badge|card|checkbox|datetime|fab|img|infinite-scroll|loading|menu|modal|picker|range|refresher|segment|select|slides|split-pane|tabs|toggle|virtual-scroll|cordova)/i
  ],
